...
const faqs = [
  {
    ...
    answer: "TapRight never accesses your credit card details, bank accounts, or transaction history. We only use your device's location to detect merchants and show you the best card match. All your card information stays securely on your device."
  },
  {
    question: "Do I need to link my bank accounts?",
    answer: "No, TapRight does not require any bank account linking. You simply add your credit cards manually, and we use location data to recommend the best card for each merchant."
  },
  {
    question: "Which credit cards does TapRight support?",
    answer: "TapRight supports all major credit cards from Visa, Mastercard, American Express, and Discover. You can add any credit card to your TapRight account."
  },
  {
